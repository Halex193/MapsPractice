...
import org.w3c.xhr.*
import google.maps.Data.DataOptions
import google.maps.Data.Feature
import google.maps.Data.FeatureOptions
import google.maps.Data.GeoJsonOptions
import google.maps.Data.StyleOptions
import google.maps.Data.Geometry
import google.maps.Data.LineString
import google.maps.Data.LinearRing
...
external open class LatLng {
    constructor(lat: Number, lng: Number, noWrap: Boolean = definedExternally)
    constructor(literal: LatLngLiteral, noWrap: Boolean = definedExternally)
...
external open class LatLngBounds {
    constructor(sw: LatLng = definedExternally, ne: LatLng = definedExternally)
    constructor(sw: LatLng = definedExternally, ne: LatLngLiteral = definedExternally)
    constructor(sw: LatLngLiteral = definedExternally, ne: LatLng = definedExternally)
    constructor(sw: LatLngLiteral = definedExternally, ne: LatLngLiteral = definedExternally)
...
external open class Marker(opts: ReadonlyMarkerOptions = definedExternally) : MVCObject {
    ...
    open fun getMap(): dynamic /* Map__0? | StreetViewPanorama? */
    ...
    open fun addListener(eventName: String, handler: (self: Marker, args: Any) -> Unit): MapsEventListener
...
external interface MarkerOptions {
    ...
    var label: dynamic /* String? | MarkerLabel? */
        get() = definedExternally
        set(value) = definedExternally
    var map: dynamic /* Map__0? | StreetViewPanorama? */
        get() = definedExternally
        set(value) = definedExternally
    var opacity: Number?
        get() = definedExternally
...
external interface InfoWindowHandlerMap {
    var closeclick: dynamic /* JsTuple<> */
        get() = definedExternally
        set(value) = definedExternally
    var content_changed: dynamic /* JsTuple<> */
        get() = definedExternally
        set(value) = definedExternally
    var domready: dynamic /* JsTuple<> */
        get() = definedExternally
        set(value) = definedExternally
    var position_changed: dynamic /* JsTuple<> */
        get() = definedExternally
        set(value) = definedExternally
    var zindex_changed: dynamic /* JsTuple<> */
        get() = definedExternally
        set(value) = definedExternally
}

external open class InfoWindow(opts: InfoWindowOptions = definedExternally) : MVCObject {
    open fun <N : Any> addListener(eventName: N, handler: MVCEventHandler<InfoWindow /* this */, Any>): MapsEventListener
    override fun addListener(eventName: String, handler: MVCEventHandler<MVCObject, Array<Any>>): MapsEventListener
    open fun close()
    open fun getContent(): dynamic /* String | Node */
    open fun getPosition(): LatLng
    open fun getZIndex(): Number
    open fun open(map: Map__0 = definedExternally, anchor: MVCObject = definedExternally)
...
external open class Data(options: DataOptions = definedExternally) : MVCObject {
    ...
    open class MultiPolygon(elements: Array<dynamic /* Polygon | Array<dynamic /* LinearRing | Array<dynamic /* LatLng | LatLngLiteral */> */> */>) : Geometry {
        open fun getArray(): Array<google.maps.Data.Polygon>
        open fun getAt(n: Number): google.maps.Data.Polygon
        open fun getLength(): Number
    }
...
external open class GroundOverlay : MVCObject {
    constructor(url: String, bounds: LatLngBounds, opts: GroundOverlayOptions = definedExternally)
    constructor(url: String, bounds: LatLngBoundsLiteral, opts: GroundOverlayOptions = definedExternally)
    open fun getBounds(): LatLngBounds
    open fun getMap(): Map__0
    open fun getOpacity(): Number
    open fun getUrl(): String
...
external open class MaxZoomService {
    open fun getMaxZoomAtLatLng(latlng: LatLng, callback: (result: dynamic /* MaxZoomResultError | MaxZoomResultOk */) -> Unit)
    open fun getMaxZoomAtLatLng(latlng: LatLngLiteral, callback: (result: dynamic /* MaxZoomResultError | MaxZoomResultOk */) -> Unit)
}

external interface MaxZoomResultError {
    var status: Any
}

external interface MaxZoomResultOk {
    var status: Any
    var zoom: Number
}
...
external interface DistanceMatrixRequest {
    ...
    var avoidTolls: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var destinations: Array<dynamic /* String | LatLng | LatLngLiteral | Place */>?
        get() = definedExternally
        set(value) = definedExternally
    var drivingOptions: DrivingOptions?
        get() = definedExternally
    ...
    var durationInTraffic: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var origins: Array<dynamic /* String | LatLng | LatLngLiteral | Place */>?
        get() = definedExternally
        set(value) = definedExternally
    var region: String?
        get() = definedExternally
...
external interface LocationElevationRequest {
    var locations: Array<dynamic /* LatLngLiteral | LatLng */>
}

external interface PathElevationRequest {
    var path: Array<dynamic /* LatLngLiteral | LatLng */>?
        get() = definedExternally
        set(value) = definedExternally
    var samples: Number?
        get() = definedExternally
