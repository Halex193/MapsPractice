...
import google.maps.GeocoderAddressComponent
import google.maps.LatLng

external open class Autocomplete(inputField: HTMLInputElement, opts: AutocompleteOptions = definedExternally) : MVCObject {
...
external open class SearchBox(inputField: HTMLInputElement, opts: SearchBoxOptions = definedExternally) : MVCObject {
    open fun getBounds(): LatLngBounds
...
external open class PlacesService {
    ...
    constructor(attrContainer: Map__0)
...
external interface AutocompletionRequest {
    ...
    var offset: Number?
        get() = definedExternally
        set(value) = definedExternally
    var origin: dynamic /* LatLng? | LatLngLiteral? */
        get() = definedExternally
        set(value) = definedExternally
    var radius: Number?
        get() = definedExternally
