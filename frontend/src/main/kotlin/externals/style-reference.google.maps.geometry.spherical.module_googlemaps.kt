...
external fun computeArea(path: MVCArray<LatLng>, radius: Number = definedExternally): Number
...
external fun computeLength(path: MVCArray<LatLng>, radius: Number = definedExternally): Number
...
external fun computeSignedArea(loop: MVCArray<LatLng>, radius: Number = definedExternally): Number
